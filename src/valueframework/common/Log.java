...
public static void printNormativeActions(String title, ArrayList<NormativeAction> normativeActions) {
		
		String print = title;
		for(NormativeAction act: normativeActions)
			print += act.toString() + " | ";
		System.out.println("NF-nac: " + print);
	}
